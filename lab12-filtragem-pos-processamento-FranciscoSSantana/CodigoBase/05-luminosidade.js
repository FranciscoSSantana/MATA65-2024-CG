...
import { BrightnessShader }		from '/CodigoBase/BrightnessShader.js';
...
const 	params = { enable : true, brightness : 1.0, canalDeCor : 'gray' };
...
function main() {
	...
	gui.add( params, 'brightness', 0.0, 4.0 ).onChange(onChangeGUI);
...
function onChangeGUI() {
	...
	if ( params.enable == true) { 
		...
		composer.passes[2].uniforms.brightness.value = params.brightness;
		composer.render();
	}
	else 
